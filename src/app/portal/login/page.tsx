        ...
        {mode === "login" ? (
          <>
            <div className="text-center mb-8">
              ...
              <p className="text-white/50 text-sm">Sign in to your artist account.</p>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div className="relative">
                ...
                <input type="email" value={email} onChange={(e) => { setEmail(e.target.value); setError(""); }}
                  placeholder="your@email.com" required autoFocus className={inp + " pl-10 pr-4"} />
              </div>
            ...
            <div className="flex items-center justify-between mt-6">
              ...
              <Link href="/submit" className="text-white/25 hover:text-white/60 text-xs transition-colors">
                Not an artist yet? Apply
              </Link>
            </div>
          </>
        ) : resetSent ? (
