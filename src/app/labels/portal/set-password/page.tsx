...
export default function LabelSetPasswordPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (updateError) {
      ...
      setDone(true);
      setTimeout(() => router.replace("/labels/portal"), 2500);
    }
  }
      ...
      <div className="w-full max-w-sm">
        ...
        {done ? (
          <div className="text-center">
            ...
            <p className="text-white/50 text-sm">Taking you to your label portal…</p>
          </div>
        ) : !ready ? (
          <div className="text-center">
          ...
          <>
            <div className="text-center mb-8">
              ...
              <p className="text-white/50 text-sm">Choose a strong password for your label account.</p>
            </div>
