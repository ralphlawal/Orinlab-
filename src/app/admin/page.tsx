...
import { Music, MessageSquare, Clock, CheckCircle2, XCircle, ArrowRight, Mail, Palette } from "lucide-react";
...
export default function AdminDashboard() {
  const [stats, setStats] = useState<Stats>({ pending: 0, approved: 0, rejected: 0, messages: 0, subscribers: 0, pendingAssets: 0 });
  ...
  return (
    <div className="space-y-8 max-w-6xl">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <StatCard icon={<Palette size={20} />} label="Asset Reqs" value={stats.pendingAssets} color="text-orange-400" bg="bg-orange-400/10" />
      </div>
